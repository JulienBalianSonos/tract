...
//! `activation` selects core activation operators, `cpu` owns ordinary expert
//! execution, and `q40` owns packed Q40 expert plans and scratch. Public operator paths
...
use cpu::{build_expert_plan, build_router_plan};
pub use nnef::register;
use q40::{build_q40_linear_expert_plan, q40_direct_activation_supported};
