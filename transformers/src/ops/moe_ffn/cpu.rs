...
impl OpStateFreeze for OptMoeFfnState {
    fn freeze(&self) -> Box<dyn FrozenOpState> {
        Box::new(FrozenOptMoeFfnState {
            ...
            packed_q40: matches!(self.experts, CpuExpertState::PackedQ40(_)),
        })
    }
}
impl FrozenOpState for FrozenOptMoeFfnState {
    fn unfreeze(&self) -> Box<dyn OpState> {
        Box::new(OptMoeFfnState {
            ...
            experts: if self.packed_q40 {
                CpuExpertState::PackedQ40(Box::default())
            } else {
                CpuExpertState::PerExpert
            },
        })
    }
}
