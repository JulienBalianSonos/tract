...
register_simple_model_transform!("fuse_sdpa_inplace_kv", ops::fused_sdpa::FusedSdpaTransform);
...
register_simple_model_transform!("fuse_gpt_oss_sdpa", ops::fused_sdpa::FusedSdpaTransform);
